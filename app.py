...
async def process_force_audio_alert_text(message: Message, state: FSMContext):
    ...
    async with AsyncSessionLocal() as session:
        ...
        for tid in set(target_ids):
            ...
            hdr_fa = {
                "tr": "🚨🔊 <b>OKUL YÖNETİMİ ACİL SESLİ ÇAĞRI</b>",
                "ru": "🚨🔊 <b>СРОЧНОЕ ЗВУКОВОЕ ОПОВЕЩЕНИЕ ШКОЛЫ</b>",
                "uz": "🚨🔊 <b>MAKTAB MA'MURIYATI SHOSHILINCH CHAQIRUVI</b>",
                "en": "🚨🔊 <b>SCHOOL ADMINISTRATION URGENT AUDIO ALERT</b>"
            }.get(u_l, "🚨🔊 <b>URGENT ALERT</b>")

            ftr_fa = {
                "tr": "⚠️ <i>Bu bildirim okul idaresi tarafından yüksek öncelikle sesli olarak iletilmiştir.</i>",
                "ru": "⚠️ <i>Это экстренное сообщение со звуковым сигналом высокой важности.</i>",
